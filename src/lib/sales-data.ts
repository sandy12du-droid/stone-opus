...
// Executive tone system — semantic tokens only. Stages progress from neutral
// (early) → info (mid-funnel) → accent (commercial) → primary (committed).
export const STAGE_TONE: Record<SalesStage, string> = {
  "New Lead": "bg-muted text-muted-foreground border-border",
  Qualified: "bg-muted/60 text-foreground/80 border-border",
  Contacted: "bg-info/10 text-info border-info/20",
  "Meeting Scheduled": "bg-info/15 text-info border-info/25",
  "Quotation Sent": "bg-warning/10 text-warning border-warning/20",
  Negotiation: "bg-accent/15 text-accent-foreground border-accent/30",
  "Order Confirmed": "bg-success/10 text-success border-success/20",
  Production: "bg-primary/10 text-primary border-primary/20",
  Shipping: "bg-primary/15 text-primary border-primary/25",
